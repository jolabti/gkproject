...
<script src="<?= base_url();?>assets/ajf.js"></script>
...
<script src="<?= base_url();?>assets/be/operational.js"></script>
<script src="<?= base_url();?>assets/be/auth.js"></script>
...
<script src="<?= base_url();?>assets/ckeditor/component.js"></script>
<!-- Bootstrap 3.3.7 -->
...
<!-- Morris.js charts -->
<script src="<?= base_url();?>assets/be/bower_components/raphael/raphael.min.js"></script>
<script src="<?= base_url();?>assets/be/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="<?= base_url();?>assets/be/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?= base_url();?>assets/be/bower_components/moment/min/moment.min.js"></script>
<script src="<?= base_url();?>assets/be/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?= base_url();?>assets/be/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?= base_url();?>assets/be/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
<script src="<?= base_url();?>assets/be/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<?= base_url();?>assets/be/bower_components/fastclick/lib/fastclick.js"></script>

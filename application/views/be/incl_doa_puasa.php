<section class="content-header" id="inputPageDoaPuasa">
 
      <ol class="breadcrumb">
        <li><a><i class="fa fa-calendar"></i>Jadwal Kegiatan</a></li>
        <li class="active">Doa Puasa</i>
...
<section class="content">
          ...
          <div class="box box-primary">
             ...
             <div class="box-header with-border">
                 ...
                 <h3 class="box-title">Doa Puasa</h3>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10" align="right">
                          ...
                          <a href="#" class="btn btn-primary" id="btnDopus">Simpan</a>
      ...
      <section class="content">
        ...
        <div class="box">
                ...
                <!-- /.box-body -->            
                <div class="box-body">
                      <table class="table" id= "records_table_dopus">

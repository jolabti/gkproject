<section class="content-header" id="inputPageDoaRantai">
 
      <ol class="breadcrumb">
        <li><a><i class="fa fa-calendar"></i>Jadwal Kegiatan</a></li>
        <li class="active">Doa Rantai</i>
...
<section class="content">
          ...
          <div class="box box-primary">
             ...
             <h3 class="box-title">Doa Rantai</h3>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10" align="right">
                          ...
                          <a href="#" id="btnDorantai" class="btn btn-primary">Simpan</a>
      ...
      <section class="content">
        ...
        <div class="box">
                ...
                <!-- /.box-body -->            
                <div class="box-body">
                            <table class="table" id="records_table_doarantai">

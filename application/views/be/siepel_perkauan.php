<section class="content-header">
    <h1>Seksi Pelayanan</h1>
      <ol class="breadcrumb">
        <li><a><i class="fa fa-users"></i> Seksi Pelayanan</a></li>
        <li class="active">Perkauan</i>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Seksi Pelayanan Perkauan</h3>
            </div>
            <div class="box-body">
                
                <div class="col-sm-2">
                  <div class="form-group">
                   <!-- <a href="seksi_pelayanan_tambah_perkaria.php?id_seksi_pelayanan.php" class="btn btn-primary pull-left" style="margin-left: 5px;" ><i class="fa fa-plus"></i>  Tambah Data</a><br> -->
            ...
            <tr>
              ...
              <td>
                ...
                <a href="#" onclick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger"><i class="fa fa-delete"></i>Hapus</a>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modalPerkauanID">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

        <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLabel">Perkauan</h3>
            <hr>
